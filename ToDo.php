...
session_start();
 // Remember to change to your own database
  define('DB_USER', 'eokobiah1');
  define('DB_PASS', 'eokobiah1');
  define('DB_NAME', 'eokobiah1');
...
<html lang="en">
    ...
    <header>
        <img id = logo
        src="./logo3.jpg "  style="width: 150px; height:150px;" >
        <img id = banner
        src="./banner.jpg "  style="width: 1000px; height:150px;" >
    </header>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="task">
                ...
                else if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete-button'])) {
                    $taskId = $_POST['taskId'];
                    $userID = $_SESSION['userid'];
...
//                        $taskId = $row['id'];
//                        $isChecked = $row['done'] == 1 ? 'checked' : '';
//                        echo "<li class='$isChecked' data-task-id='$taskId'>" . $row['description'] . "<button class='delete-button' name='deleteTask' type='submit'>X</button></li>";
//                    }
//                } else {
